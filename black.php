<?php
  $array = [
    ...
    "A que dedicaré el meu pròxim voluntariat?",
    "Què és el que més troba a faltar d'Àfrica una persona despreés de 15 anys a Europa?",
    "Què va causar el divorci dels avis?",
    "Què va causar el naixement de VOX?",
    "Què li encanta al president segons els mitjans de comunicació?",
    "Què dir en ple sexe per posar calenta a la teva parella",

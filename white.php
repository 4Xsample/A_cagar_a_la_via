<?php
  $array = [
    ...
    "El tio cridaner del gimnàs",
    "Un Bebè que no para de plorar en un vol",
    "Al-Qaida",
    "Els meus amics",
    "Els socis de creadors",
    "Gais fotent-se ma",
    "Uns calçotets suats",
    ...
    "El club super 3",
    "Narcotraficants comobians",
    "Metges sud-americans",
    "La classe sencera de P4",
    ...
    "Un nen soldat",
    "Una bona mamada",
    "l'exhumacio de Franco",
    "La moreneta",
    "Semen d'antivacunes",
    "Fisting amb una botella esquerdada",
